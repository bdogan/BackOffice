...
class ThemesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'alias' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'is_active' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'theme_alias_index' => ['type' => 'unique', 'columns' => ['alias'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
