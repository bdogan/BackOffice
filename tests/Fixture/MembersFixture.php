...
class MembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_login_ip' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'last_login' => '2019-10-22 18:22:13',
                'created' => '2019-10-22 18:22:13',
                'modified' => '2019-10-22 18:22:13'
            ],
        ];
        parent::init();
    }
